...
func (m *QueryGrantsAllRequest) Reset()         { *m = QueryGrantsAllRequest{} }
func (m *QueryGrantsAllRequest) String() string { return proto.CompactTextString(m) }
...
func (m *QueryGrantsAllRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGrantsAllRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGrantsAllRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGrantsAllRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGrantsAllRequest.Merge(m, src)
}
func (m *QueryGrantsAllRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryGrantsAllRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGrantsAllRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGrantsAllRequest proto.InternalMessageInfo

func (m *QueryGrantsAllRequest) GetPagination() *query.PageRequest {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func (*QueryGranteeGrantsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_376d714ffdeb1545, []int{6}
}
...
func init() {
	...
	proto.RegisterType((*QueryGrantsAllRequest)(nil), "cosmos.authz.v1beta1.QueryGrantsAllRequest")
...
var fileDescriptor_376d714ffdeb1545 = []byte{
	...
	,
}
...
func (c *queryClient) GrantsAll(ctx context.Context, in *QueryGrantsAllRequest, opts ...grpc.CallOption) (*QueryGrantsResponse, error) {
	out := new(QueryGrantsResponse)
	err := c.cc.Invoke(ctx, "/cosmos.authz.v1beta1.Query/GrantsAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedQueryServer) GrantsAll(ctx context.Context, req *QueryGrantsAllRequest) (*QueryGrantsResponse, error) {
...
func _Query_GrantsAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.authz.v1beta1.Query/GrantsAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *QueryGrantsAllRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGrantsAllRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGrantsAllRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryGrantsAllRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGrantsAllRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGrantsAllRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGrantsAllRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
